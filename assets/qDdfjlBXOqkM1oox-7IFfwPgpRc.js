;if(CloudflareApps.matchPage(CloudflareApps.installs['Udmg8bySkPJD'].URLPatterns)){(function(){'use strict'
if(!window.addEventListener)return
if(window.frameElement)return
var options=CloudflareApps.installs['Udmg8bySkPJD'].options
var element
...
window.CloudflareApps.installs['Udmg8bySkPJD'].scope={setOptions:function setOptions(nextOptions){options=nextOptions
